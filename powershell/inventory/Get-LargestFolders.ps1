...
.EXAMPLE
powershell -ExecutionPolicy Bypass -File .\powershell\inventory\Get-LargestFolders.ps1

.EXAMPLE
powershell -ExecutionPolicy Bypass -File .\powershell\inventory\Get-LargestFolders.ps1 -DriveLetter D -Top 20
#>
