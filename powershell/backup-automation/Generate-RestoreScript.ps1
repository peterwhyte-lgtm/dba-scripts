...
.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell\backup-automation\Generate-RestoreScript.ps1

.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell\backup-automation\Generate-RestoreScript.ps1 -ServerInstance PROD01\SQL2019
#>
param(
