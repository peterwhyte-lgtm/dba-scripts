...
.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell\wrappers\backups\Generate-FullBackupScript.ps1

.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell\wrappers\backups\Generate-FullBackupScript.ps1 -ServerInstance PROD01\SQL2019
#>
param(
