...
.EXAMPLE
pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\powershell\wrappers\performance\Get-WaitStatistics.ps1 -ServerInstance . -Database master -OutputFormat Csv -OutputPath .\output-files\wait-stats.csv
#>
