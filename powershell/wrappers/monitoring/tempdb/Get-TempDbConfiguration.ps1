<#
.SYNOPSIS
Reviews TempDB file configuration — file count, sizing parity, autogrowth
...
.EXAMPLE
.\powershell\wrappers\monitoring\tempdb\Get-TempDbConfiguration.ps1 -ServerInstance PROD01\SQL2019 -OutputFormat Csv
#>
...
$sqlScript = Join-Path $repoRoot 'sql\monitoring\tempdb\Get-TempDbConfiguration.sql'
...
Write-Host 'Running Get-TempDbConfiguration...' -ForegroundColor Cyan
