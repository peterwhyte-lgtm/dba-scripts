...
SELECT TOP 20
    ...
    qs.execution_count,
    CAST(qs.total_elapsed_time / NULLIF(qs.execution_count, 0) / 1000.0 AS DECIMAL(12,1)) AS avg_elapsed_ms,
    ...
    CAST(qs.total_worker_time / NULLIF(qs.execution_count, 0) / 1000.0 AS DECIMAL(12,1)) AS avg_cpu_ms,
